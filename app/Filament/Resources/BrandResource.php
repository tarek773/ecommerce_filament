...
class BrandResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'name'; //berguna untuk search name di navbar

    protected static ?int $navigationSort = 2; //berguna untuk mengurutkan menu navigasi
